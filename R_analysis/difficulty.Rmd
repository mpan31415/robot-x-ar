...
ggqqplot(tlx_df, "difficulty", facet.by = "condition")
...
res.aov <- anova_test(data = tlx_df, dv = difficulty, wid = pid, within = condition)
...
##### kruskal-wallis test
res.kruskal <- tlx_df %>% kruskal_test(difficulty ~ condition)
res.kruskal

tlx_df %>% kruskal_effsize(difficulty ~ condition)


# ######################### SIG 2-WAY INTER: Pairwise comparisons between group levels #########################  
# pwc <- tlx_df %>%
#   group_by(condition) %>%
#   pairwise_t_test(difficulty ~ order, p.adjust.method = "bonferroni")
# pwc
# 
# ######################### NON-SIG 2-WAY INTER: Pairwise comparisons between group levels #########################
# tlx_df %>%
#   pairwise_t_test(
#     difficulty ~ autonomy, paired = TRUE,
#     p.adjust.method = "bonferroni"
#   )
# 
# tlx_df %>%
