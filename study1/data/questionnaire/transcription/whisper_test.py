...
audio_files_path = getcwd() + "\\study1\\data\\questionnaire\\transcription\\audio_files"
...
for file in audio_files:
    ...
    audio_file= open(getcwd() + "\\study1\\data\\questionnaire\\transcription\\audio_files\\" + file, "rb")
...
dest_path = getcwd() + "\\study1\\data\\questionnaire\\transcription\\transcription.csv"
