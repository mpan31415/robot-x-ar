...
##########################################################################################
def get_task_data():
    my_file_dir = getcwd() + "\\study2\\data\\test\\mt_grouped.csv"
...
df = replace_outliers_within_group(df, ['condition'], "time")

# write new dataframe to csv file
dest_path = getcwd() + "\\study2\\data\\test\\mt_grouped_no_outlier.csv"
