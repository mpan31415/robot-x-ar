...
p <- ggplot(df_summary, aes(x=tlx_item, y=tlx_score, fill=condition)) + 
  ...
  ylim(-1, 20) +
  theme_minimal() +
  labs(y = "NASA-TLX Score (1-20)", x = "") +
  theme(axis.text.x = element_text(hjust = 0.5, size = 13, face = "bold"),  # Rotate x-axis labels
        legend.position = "bottom", legend.title = element_text(size=14), legend.text = element_text(size=14, face="bold"),
...
ggsave("study2_tlx.pdf", plot = p, width = 8, height = 5, device = "pdf")
