...
ggsave("movement_time2.pdf", plot = p, width = 4, height = 5, device = "pdf")
...
ip <- ggplot(df_summary2, aes(x=cond_order, y=time, fill=condition)) + 
  ...
  theme_minimal() +
  labs(y = "Movement Time (s)", x = "") +
  theme(axis.text.x = element_text(hjust = 0.5, size = 18, face = "bold"),  # Rotate x-axis labels
...
ggsave("movement_time2inter.pdf", plot = ip, width = 6, height = 5, device = "pdf")
